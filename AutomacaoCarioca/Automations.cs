...
namespace AutomacaoCarioca
{
    public class Automations : IDisposable
    {
        ...
        public void Login(string user, string password)
        {
            ...
            HelperPath.ValidationToReturnElement(PathsToAutomations.ByBtnLogin, 1, 10).Click();

            if (Driver.FindElement(By.XPath(PathsToAutomations.ByLabelError)).Enabled != true)
            {
        ...
        {
            if (Driver.FindElement(By.XPath(PathsToAutomations.BySelectError)).Enabled != true)
            {
